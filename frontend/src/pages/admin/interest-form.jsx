...
export default function interestForm() {
  ...
  const onSubmit = (values) => {
    ...
    return (
      <Layout>
        <Topbar view={view} setView={setView} title="Add New Interest" mode="form" />
        <div className='w-{80%} m-auto py-4'>
          <div className="flex flex-col items-center mb-6">
            <Users className="w-12 h-12 text-purple-600 mb-2" />
            <h2 className="text-2xl font-semibold text-gray-800">Add New Interest</h2>
            <p className="text-gray-600 text-sm">Fill out the details below to add a new interest</p>
          </div>
          <Form {...interestForm}>
            <form onSubmit={interestForm.handleSubmit(onSubmit)} className='space-y-6'>
